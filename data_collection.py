...
def obter_dados_binance(symbol, start_date, end_date, interval=Client.KLINE_INTERVAL_1DAY, cache_dir="cache"):
    api_key = 'JOs9K3R0nZAeaE9bL5TQzxoDuPPw5m9rwGQHq7LqwRO0cWRRN18RRFOBollzkWhX'  # Substitua com sua chave real
    api_secret = 'G7MSOpeglBlj9anbJlMa5d8MnhSqS6yoHQa3PyIgfbdMdFSFAwSf5iHYhkkTr5z7' # Substitua com seu segredo real
...
if __name__ == '__main__':
    ...
    try:
      ...
      bitcoin_data.to_csv('bitcoin_data_analise.csv', index=False)
      print("Dados e análise salvos em bitcoin_data_analise.csv")
    except ValueError as e:
